...
<template>
  ...
  >
    <div
      class="flex flex-col lg:flex-row bg-white rounded-md w-full overflow-hidden"
    >
      <div
      ...
      >
        <button
          ...
          :class="{
            'after:max-h-[100px] text-[--text-color] bg-white': activeTab == 1,
          }"
          type="button"
        ...
        <button
          class="text-left md:text-base p-4 md:p-6 relative after:content-[''] after:absolute after:top-0 after:left-0 after:w-[3px] after:h-full after:max-h-0 after:bg-[--primary-color] after:transition-all after:duration-500 after:ease-in-out hover:after:max-h-[100px] hover:bg-white transition-all duration-300"
          :class="{
            'after:max-h-[100px] text-[--text-color] bg-white': activeTab == 2,
          }"
          type="button"
        ...
        <button
          class="text-left md:text-base p-4 md:p-6 relative after:content-[''] after:absolute after:top-0 after:left-0 after:w-[3px] after:h-full after:max-h-0 after:bg-[--primary-color] after:transition-all after:duration-500 after:ease-in-out hover:after:max-h-[100px] hover:bg-white transition-all duration-300"
          :class="{
            'after:max-h-[100px] text-[--text-color] bg-white': activeTab == 3,
          }"
          type="button"
      ...
      <div class="flex-1 max-w-[740px]">
        <ProfileSavedItemsJobs v-if="activeTab == 1" />
        <ProfileSavedItemsCompanies v-if="activeTab == 2" />
      </div>
    </div>
  </div>
</template>
