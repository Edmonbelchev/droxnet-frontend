  ...
  <div class="px-4 py-8">
    <div class="flex flex-col lg:flex-row max-w-[1110px] gap-8 w-full mx-auto">
      <div class="lg:max-w-[730px] flex flex-col gap-6 w-full">
        ...
        <div
          class="bg-white rounded-md pb-6"
          v-if="user.experiences && user.experiences.length > 0"
        >
          ...
          <UserExperienceItem
            ...
            :key="index"
            :className="[index % 2 === 0 ? 'p-6 bg-[#fafafa]' : 'p-5 bg-white']"
          />
        </div>

        <div
          class="bg-white rounded-md pb-6"
          v-if="user.educations && user.educations.length > 0"
        >
      ...
      <div class="max-w-[580px] lg:max-w-[350px] w-full flex flex-col gap-6">
        <div
          class="flex flex-col bg-white p-6 rounded-md"
          v-if="user.awards && user.awards.length > 0"
        >
